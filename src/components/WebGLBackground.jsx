...
function FluidShape() {
  ...
  return (
    <>
      <pointLight ref={lightCyan} color="#C8CBD0" intensity={50} distance={20} position={[0, 0, 2]} />
      <pointLight ref={lightGreen} color="#FFFFFF" intensity={30} distance={20} position={[0, 0, 2]} />
      <ambientLight intensity={0.1} color="#050505" />
